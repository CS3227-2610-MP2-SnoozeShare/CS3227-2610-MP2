...
- **Last updated:** 2026-09-27 by Codex — W8 review fix complete: past-request status badges
...
| S14 | 2026-09-26 | Codex | w8 | W8 — Host Request Queue, Earnings & Disputes | Paused | Review fixes complete: context, host-owned classes, modal fixes, widths, and status badges verified; awaiting operator confirmation | 2026-09-27 |
...
| W8 | F7 — Host Request Queue, Earnings & Disputes | In review | [host requests/earnings design](docs/superpowers/specs/2026-09-26-w8-host-requests-earnings-design.md) | [host requests/earnings plan](docs/superpowers/plans/2026-09-26-w8-host-requests-earnings.md) | Review fixes complete: context, host-owned selectors, modal fixes, widths, and status badges; broader F7.2.2 deferred to W13 | Awaiting confirmation |
