...
CREATE TABLE properties (
    ...
    propertyType TEXT NOT NULL CHECK (
        propertyType IN ('APARTMENT', 'HOUSE', 'CONDO', 'PRIVATE_ROOM')),
...
CREATE TABLE bookings (
    ...
    status TEXT NOT NULL CHECK (status IN (
        'PENDING', 'CONFIRMED', 'REJECTED', 'CANCELLED_BY_GUEST',
        'CANCELLED_BY_HOST', 'COMPLETED', 'FORCE_CANCELLED', 'FORCE_COMPLETED')),
...
CREATE TABLE tickets (
    ...
    title TEXT NOT NULL,
    description TEXT NOT NULL,
    requestedRemedy TEXT NOT NULL CHECK (
        requestedRemedy IN ('FULL_REFUND', 'PARTIAL_REFUND', 'HOST_PAYOUT', 'OTHER')),
    supportingText TEXT,
    status TEXT NOT NULL CHECK (
        status IN ('OPEN', 'UNDER_REVIEW', 'RESOLVED_APPROVED', 'RESOLVED_REJECTED')),
