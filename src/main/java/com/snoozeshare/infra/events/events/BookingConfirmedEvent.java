...
public record BookingConfirmedEvent(UUID bookingId, UUID actorId, Instant occurredAt,
                                    UUID eventId) implements DomainEvent {
    public BookingConfirmedEvent(UUID bookingId, UUID actorId, Instant occurredAt) {
